        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyedCount = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOrderHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserOrderHistories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CartId = table.Column<int>(nullable: false),
                    UserOrderHistoryId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_UserOrderHistories_UserOrderHistoryId",
                        column: x => x.UserOrderHistoryId,
                        principalTable: "UserOrderHistories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryProducts_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_UserOrderHistoryId",
                table: "Orders",
                column: "UserOrderHistoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOrderHistories_IsDeleted",
                table: "UserOrderHistories",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_UserOrderHistories_UserId",
                table: "UserOrderHistories",
                column: "UserId");
        }
